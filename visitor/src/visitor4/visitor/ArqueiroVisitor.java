...
public class ArqueiroVisitor implements PersonagemVisitor{
	...
	public void VisitLanceiro(Lanceiro lanceiro) {
		lanceiro.setPontoVida(lanceiro.getPontoVida() - (this.atacante.getForcaAtaque() + 1));
	}

	@Override
	public void VisitArqueiro(Arqueiro arqueiro) {
		arqueiro.setPontoVida(arqueiro.getPontoVida() - this.atacante.getForcaAtaque());
	}
